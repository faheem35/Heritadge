    ...
    <section id="about" className="py-20 bg-amber-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-blue-950 mb-4">About Heritadge</h2>
...
<div className="flex justify-center md:justify-start mt-6">
  <a
    href="#portfolio"
    className="bg-orange-700 text-white px-8 py-3 font-semibold hover:bg-gray-600 transition rounded-lg"
  >
    Discover More
  </a>
</div>
