    ...
    <section id="about" className="py-20 bg-amber-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-primary mb-4">About Heritage</h2>
...
/>
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <button className="bg-gray-600 text-white px-8 py-3 font-semibold hover:bg-gray-900 transition mt-6 cursor-pointer">
                Discover More
              </button>
            </div>
          </div>
